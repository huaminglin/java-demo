...
public class StringConstantPoolDemo {
  ...
  public static void main(String[] args) throws InterruptedException, ClassNotFoundException {
    System.out.println("StringConstantPoolDemo.class.getName() is intern string: " + isInternString(
        StringConstantPoolDemo.class.getName()));
    ...
    {
      Class.forName("huaminglin.demo.jvm.constant.pool.StaticStringFieldClass", false,
          ClassLoader.getSystemClassLoader());
      System.out.println("Check heap dump about StaticStringFieldClass. First sleep: " + sleep1);
      Thread.sleep(1000 * sleep1);

      Class.forName("huaminglin.demo.jvm.constant.pool.StaticStringFieldClass", true,
          ClassLoader.getSystemClassLoader());
