...
public class ZoneIdDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Zone ID, TimeZone(January), Daylight Savings First Shift, TimeZone(After Shift), Daylight Savings Second Shift");
    ...
    for (String strtimezone : availableIDs) {
      ...
      if (zoneOffsetTransition != null) {
        ...
        afterFirstShift = ZonedDateTime.ofInstant(zoneOffsetTransition.getInstant(), zoneId)
      ...
      System.out.println(strtimezone + ", " + januaryOffset + ", " + firstTransition + ", " + rules
          .getOffset(afterFirstShift) + ", " + secondTransition);
    }
